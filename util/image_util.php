...
function process_image($dir, $filename) {
	...
	$image_path_300 = $dir . $image_name . '_300' . $ext;
	
	// Create an image that's a maximum of 300x350 pixels
	resize_image($image_path, $image_path_300, 300, 350);
...
function resize_image($old_image_path, $new_image_path, $max_width, $max_height) {
	...
	// Get the old image and its dimensions
	...
	// If image is larger than allowed ratio, create new image.
