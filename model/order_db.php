...
function tax_amount($subtotal, $state) {
    switch ($state) {
...
function add_order($card_type, $card_number, $card_cvv, $card_expires) {
    ...
    $query = '
         INSERT INTO orders (customerID, orderDate, shipAmount, taxAmount,
                             shippingAddress, cardType, cardNumber,
                             cardExpires, billingAddressID, specialInstructions, orderStatus, orderTotal)
         VALUES (:customer_id, :order_date, :ship_amount, :tax_amount,
                 :shipping_address, :card_type, :card_number,
                 :card_expires, :billing_id, :specialInstructions, :orderStatus, :order_total)';
    ...
    $statement->bindValue(':specialInstructions', $specialInstructions);
